...
test_that("parse_ISO8660", {
  ...
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.5678901"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
         second = "56", fraction = "5678901")
  )
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.56789012"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
         second = "56", fraction = "56789012")
  )
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.567890123"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
         second = "56", fraction = "567890123")
  )
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.5678901234"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
         second = "56", fraction = "5678901234")
  )
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.56789012345"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
         second = "56", fraction = "56789012345")
  )
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.567890123456"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
  ...
  # Timezone ####
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.567890Z"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
  ...
  expect_equal(
    parse_ISO8660("2020-11-01T12:34:56.567890+01:15"),
    list(date = TRUE, year = "2020", iso_8601_format = "extended", 
         month = "11", mday = "01", time = TRUE, hour = "12", minute = "34", 
...
test_that("duration", {
  expect_equal(
    parse_ISO8660("P1Y1M1DT1H1M1.1S"),
...
test_that("repeating interval", {
  expect_equal(
    parse_ISO8660("R/P1Y2M3DT4H5M6.7S"),
...
test_that("interval", {
  expect_equal(
    parse_ISO8660("2020-01-12/2020-02-12"),
    list(interval = TRUE,
         start = list(
           date = TRUE, year = "2020", 
  ...
  expect_equal(
    parse_ISO8660("2020-01-12/02-12"),
    list(interval = TRUE,
         start = list(
           date = TRUE, year = "2020", 
           iso_8601_format = "extended", month = "01", mday = "12"), 
